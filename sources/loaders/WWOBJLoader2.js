 ...
 * @class
 */
OBJLoader2.WWOBJLoader2 = (function () {
	...
	WWOBJLoader2.prototype._init = function () {
		console.log( "Using OBJLoader2.WWOBJLoader2 version: " + WWOBJLOADER2_VERSION );
	 ...
	 * @memberOf OBJLoader2.WWOBJLoader2
	 *
	 ...
	 * Use {@link OBJLoader2.WWOBJLoader2.LoadedMeshUserOverride} for alteration instructions (geometry, material or disregard mesh).
	 * @memberOf OBJLoader2.WWOBJLoader2
	 *
	...
	WWOBJLoader2.prototype._validate = function () {
		...
		this.mtlLoader = Validator.verifyInput( this.mtlLoader, new MTLLoader() );
		...
		var vertexColorMaterial = new MeshBasicMaterial( { color: 0xDCF1FF } );
	 ...
	 * @memberOf OBJLoader2.WWOBJLoader2
	 *
	 * @param {Object} params Either {@link OBJLoader2.WWOBJLoader2.PrepDataArrayBuffer} or {@link OBJLoader2.WWOBJLoader2.PrepDataFile}
	 */
	...
	WWOBJLoader2.prototype._receiveWorkerMessage = function ( event ) {
		...
		switch ( payload.cmd ) {
			case 'objData':
				...
				bufferGeometry.addAttribute( 'position', new BufferAttribute( new Float32Array( payload.vertices ), 3 ) );
				var haveVertexColors = Validator.isValid( payload.colors );
				if ( haveVertexColors ) {

					bufferGeometry.addAttribute( 'color', new BufferAttribute( new Float32Array( payload.colors ), 3 ) );

				}
				if ( Validator.isValid( payload.normals ) ) {

					bufferGeometry.addAttribute( 'normal', new BufferAttribute( new Float32Array( payload.normals ), 3 ) );
				...
				if ( Validator.isValid( payload.uvs ) ) {
					...
					bufferGeometry.addAttribute( 'uv', new BufferAttribute( new Float32Array( payload.uvs ), 2 ) );
				...
				for ( key in materialDescriptions ) {
					...
					if ( materialDescription.vertexColors ) material.vertexColors = VertexColors;
...
/**
 * Instruction to configure {@link OBJLoader2.WWOBJLoader2}.prepareRun to load OBJ from given ArrayBuffer and MTL from given String.
 *
 ...
 * @constructor
 */
OBJLoader2.WWOBJLoader2.PrepDataArrayBuffer = function ( modelName, objAsArrayBuffer, pathTexture, mtlAsString ) {
	...
	return {
		...
		/**
		 * {@link Object3D} where meshes will be attached.
		 * @memberOf OBJLoader2.WWOBJLoader2.PrepDataArrayBuffer
		 *
		 * @param {Object3D} sceneGraphBaseNode Scene graph object
		 */
		...
		/**
		 * Returns all callbacks as {@link OBJLoader2.WWOBJLoader2.PrepDataCallbacks}
		 * @memberOf OBJLoader2.WWOBJLoader2.PrepDataArrayBuffer
		 *
		 * @returns {OBJLoader2.WWOBJLoader2.PrepDataCallbacks}
		 */
		...
		callbacks: new OBJLoader2.WWOBJLoader2.PrepDataCallbacks()
	};
};

/**
 * Instruction to configure {@link OBJLoader2.WWOBJLoader2}.prepareRun to load OBJ and MTL from files.
 *
 * @param {string} modelName Overall name of the model
 ...
 * @constructor
 */
OBJLoader2.WWOBJLoader2.PrepDataFile = function ( modelName, pathObj, fileObj, pathTexture, fileMtl ) {
	...
	return {
		...
		/**
		 * {@link Object3D} where meshes will be attached.
		 * @memberOf OBJLoader2.WWOBJLoader2.PrepDataFile
		 *
		 * @param {Object3D} sceneGraphBaseNode Scene graph object
		 */
		setSceneGraphBaseNode: function ( sceneGraphBaseNode ) {
...
/**
 * Callbacks utilized by functions working with {@link OBJLoader2.WWOBJLoader2.PrepDataArrayBuffer} or {@link OBJLoader2.WWOBJLoader2.PrepDataFile}
 *
 * @returns {{registerCallbackProgress: OBJLoader2.WWOBJLoader2.PrepDataCallbacks.registerCallbackProgress, registerCallbackCompletedLoading: OBJLoader2.WWOBJLoader2.PrepDataCallbacks.registerCallbackCompletedLoading, registerCallbackMaterialsLoaded: OBJLoader2.WWOBJLoader2.PrepDataCallbacks.registerCallbackMaterialsLoaded, registerCallbackMeshLoaded: OBJLoader2.WWOBJLoader2.PrepDataCallbacks.registerCallbackMeshLoaded, registerCallbackErrorWhileLoading: OBJLoader2.WWOBJLoader2.PrepDataCallbacks.registerCallbackErrorWhileLoading, progress: null, completedLoading: null, errorWhileLoading: null, materialsLoaded: null, meshLoaded: null}}
 * @constructor
 */
OBJLoader2.WWOBJLoader2.PrepDataCallbacks = function () {
	...
	return {
		/**
		 * Register callback function that is invoked by internal function "_announceProgress" to print feedback.
		 * @memberOf OBJLoader2.WWOBJLoader2.PrepDataCallbacks
		 *
		 * @param {callback} callbackProgress Callback function for described functionality
		 */
...
/**
 * Object to return by {@link OBJLoader2.WWOBJLoader2}.callbacks.meshLoaded. Used to adjust bufferGeometry or material or prevent complete loading of mesh
 *
 * @param {boolean} disregardMesh=false Tell WWOBJLoader2 to completely disregard this mesh
 * @param {BufferGeometry} bufferGeometry The {@link BufferGeometry} to be used
 * @param {Material} material The {@link Material} to be used
 *
 * @returns {{ disregardMesh: boolean, replaceBufferGeometry: boolean, bufferGeometry: BufferGeometry, replaceMaterial: boolean, material: Material}}
 * @constructor
 */
OBJLoader2.WWOBJLoader2.LoadedMeshUserOverride = function ( disregardMesh, bufferGeometry, material ) {
 ...
 * @class
 */
OBJLoader2.WWOBJLoader2Director = (function () {
	...
	function WWOBJLoader2Director() {
		...
		this.workerDescription = {
			prototypeDef: OBJLoader2.WWOBJLoader2.prototype,
			globalCallbacks: {},
			webWorkers: [],
			codeBuffer: null
		};
	 ...
	 * @memberOf OBJLoader2.WWOBJLoader2Director
	 *
	 * @returns {number}
	 */
	 ...
	 * @memberOf OBJLoader2.WWOBJLoader2Director
	 *
	 * @param {Object} runParams Either {@link OBJLoader2.WWOBJLoader2.PrepDataArrayBuffer} or {@link OBJLoader2.WWOBJLoader2.PrepDataFile}
	 */
